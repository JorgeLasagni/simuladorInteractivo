...
//     const index = biblioteca.findIndex(obra => obra.id === id);
//     const obra  = biblioteca[index];
//     const {apellido, nombre, titulo, panel, subpanel, nivel, lid} = obra;
//     Swal.fire( {
//         title: "¿Confirmar ELIMINACIÓN de Obra: "+apellido,
//             icon: "warning",
//             background: "#FDEBD0",
//             backdrop: "#B7950B",
